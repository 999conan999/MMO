                ...
                {is_show_menu&&<div className='navbarz'>
                    <ul className='menuz'>
                        ...
                        <li 
                            onClick={()=>{
                                if(window.lock){
                                    if(window.confirm("Trang bạn chưa được lưu, Xác nhận chuyển trang?")){
                                        this.setState({seleted:'setup'})
                                        window.lock=false;
                                    }
                                }else{
                                    this.setState({seleted:'setup'})
                        ...
                        <li 
                            onClick={()=>{
                                if(window.lock){
                                    if(window.confirm("Trang bạn chưa được lưu, Xác nhận chuyển trang?")){
                                        this.setState({seleted:'Categorys'})
                                        window.lock=false;
                                    }
                                }else{
                                    this.setState({seleted:'Categorys'})
                        ...
                        <li 
                            onClick={()=>{
                                if(window.lock){
                                    if(window.confirm("Trang bạn chưa được lưu, Xác nhận chuyển trang?")){
                                        this.setState({seleted:'Attributes'})
                                        window.lock=false;
                                    }
                                }else{
                                    this.setState({seleted:'Attributes'})
                        ...
                        <li 
                            onClick={()=>{
                                if(window.lock){
                                    if(window.confirm("Trang bạn chưa được lưu, Xác nhận chuyển trang?")){
                                        this.setState({seleted:'Comments'})
                                        window.lock=false;
                                    }
                                }else{
                                    this.setState({seleted:'Comments'})
